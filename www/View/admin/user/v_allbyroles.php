<?foreach ($posts as $post): ?>
    <div class="jumbotron">
        ...
        <a class="btn btn-primary btn-sm" href="/<?ADMIN_URL?>/adminPost/edit/<?php echo $post['id_post'] ?>">
            Редактировать
        </a>
        <a class="btn btn-danger btn-sm" href="/<?ADMIN_URL?>/adminPost/delete/<?php echo $post['id_post'] ?>">
            Удалить
        </a>
