<? foreach ($users as $user): ?>
    <div class="jumbotron">
        ...
        <a class="btn btn-success btn-sm" href="/<?=ADMIN_URL?>/user/one/<?php echo $user['id_post'] ?>">
            Подробнее
        </a>
        <a class="btn btn-primary btn-sm" href="/<?=ADMIN_URL?>/user/edit/<?php echo $user['id_post'] ?>">
            Редактировать
        </a>
        <a class="btn btn-danger btn-sm" href="/<?=ADMIN_URL?>/user/delete/<?php echo $user['id_post'] ?>">
            Удалить
        </a>
